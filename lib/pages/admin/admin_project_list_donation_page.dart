...
import 'package:kict_crowdfunding/pages/admin/admin_project_list_donation_details_page.dart';

class AdminProjectsListDonationPage extends StatefulWidget {
  const AdminProjectsListDonationPage({super.key});
...
class AdminProjectsListOnCategoryState
    extends State<AdminProjectsListDonationPage> {
                    ...
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (context) =>
                                AdminProjectsListDonationDetailsPage(
