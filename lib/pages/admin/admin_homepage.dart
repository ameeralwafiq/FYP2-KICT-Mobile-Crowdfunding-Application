...
import 'package:kict_crowdfunding/pages/admin/admin_chat_page.dart';
import 'package:kict_crowdfunding/pages/admin/admin_notification_page.dart';
import 'package:kict_crowdfunding/pages/admin/admin_page.dart';
import 'package:kict_crowdfunding/pages/admin/admin_profile_page.dart';
import 'package:kict_crowdfunding/pages/admin/admin_project_details_page.dart';
import 'package:kict_crowdfunding/pages/admin/admin_project_list_page.dart';
import 'package:kict_crowdfunding/pages/admin/admin_setting_page.dart';
...
class AdminHomePageState extends State<AdminHomePage> {
      ...
      (event) {
        ...
        if (snapshot.exists) {
          try {
            ...
            // Parse data into a list of Project objects and filter by status
            allProjects = data.entries.map((entry) {
              ...
              return Project.fromJson(entry.key, projectData);
                ...
                // .where((project) => project.status == "approved")
                .toList();
  ...
  void _onProjectTap(Project project) {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => AdminProjectDetailsPage(project: project),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        leadingWidth: MediaQuery.sizeOf(context).width * 0.269,
        leading: Row(
          children: [
            if (expandedSection != null || searchQuery.isNotEmpty)
              IconButton(
        ...
        onTap: (index) {
          ...
          if (index == 1) {
            Navigator.push(
              context,
              MaterialPageRoute(
                  builder: (context) => const AdminProjectsListPage()),
            );
          } else if (index == 2) {
            Navigator.push(
              context,
