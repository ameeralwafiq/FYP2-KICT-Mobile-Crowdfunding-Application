...
import 'package:kict_crowdfunding/pages/user/user_project_list_to_approve.dart';

class UserProjectsListPage extends StatelessWidget {
  const UserProjectsListPage({super.key});
            ...
            ProjectCard(
              ...
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const UserProjectsListToApprove(
                            category: "Education",
                          )),
                );
