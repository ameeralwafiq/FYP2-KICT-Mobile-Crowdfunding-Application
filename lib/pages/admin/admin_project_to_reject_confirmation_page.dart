...
class AdminProjectToRejectConfirmationPage extends StatefulWidget {
  final Project project;

  const AdminProjectToRejectConfirmationPage({
    super.key,
    required this.project,
  });

  @override
  State<AdminProjectToRejectConfirmationPage> createState() =>
      _AdminProjectToRejectConfirmationPageState();
}

class _AdminProjectToRejectConfirmationPageState
    extends State<AdminProjectToRejectConfirmationPage> {
